...
import dmit2015.restclient.TodoItemDtoMultitenantMpRestClient;
...
@Named("currentMpRestClientMultiTenantTodoItemDtoService")
@ApplicationScoped
public class MpRestClientMultiTenantTodoItemDtoService implements TodoItemDtoService {

    @Inject
    @RestClient
    private TodoItemDtoMultitenantMpRestClient mpRestClient;
